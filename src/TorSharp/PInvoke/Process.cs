...
internal static partial class WindowsApi
{
    ...
    public static partial uint WaitForInputIdle(IntPtr hProcess, uint dwMilliseconds);
    ...
    // CreateProcess and CreatePipe use STARTUPINFO (has string fields) and ref structs — kept as DllImport.
    [DllImport("kernel32.dll")]
