...
{
    private readonly object _jobHandleLock = new();
    private SafeJobHandle _jobHandle = new(IntPtr.Zero);
    ...
    public Task StartAsync(Tool tool)
    {
        ...
        // Windows always wants exactly one instance of "ctfmon.exe" in the new desktop.
