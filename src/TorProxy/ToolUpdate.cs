...
public class ToolUpdate
{
    ...
    public bool HasUpdate =>
        Status == ToolUpdateStatus.NoLocalVersion || Status == ToolUpdateStatus.NewerVersionAvailable;
    ...
    /// <summary>
    /// The path that <see cref="LatestDownload"/> would be downloaded to by <see cref="TorProxyToolFetcher"/>.
    /// </summary>
