...
/// </summary>
public class TorProxyTorSettings
{
    ...
    /// <summary>
    /// Initializes an instance of the TorProxy settings with default ports set.
    /// </summary>
    public TorProxyTorSettings()
    {
    ...
    /// <summary>
    /// The unhashed version of <see cref="HashedControlPassword"/>. TorProxy will hash it on your behalf if set and
    ...
    /// other peripheral files still are extracted from the <see cref="TorProxySettings.ZippedToolsDirectory"/>.
    /// This is helpful when the tool fetched via the <see cref="TorProxyToolFetcher"/> is not compatible with the
    /// host machine.
    /// </summary>
